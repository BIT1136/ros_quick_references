...
![[Pasted image 20230407150658.png|150]]

## 状态机

使用重新映射机制在状态之间、状态机和状态之间传递数据 ：`remapping` 确定了 `userdata` 中键的名称。
...
![[Pasted image 20230407150743.png|400]]

![[Pasted image 20230411100906.png|300]]
